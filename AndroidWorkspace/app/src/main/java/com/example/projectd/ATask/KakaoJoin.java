...
public class KakaoJoin extends AsyncTask<Void, Void, String> {
    String member_id, member_nickname, member_loginType, member_token;

    public KakaoJoin(String member_id, String member_nickname, String member_loginType, String member_token) {
