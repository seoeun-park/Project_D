...
public class FavDelete extends AsyncTask<Void, Void, Void> {
    String member_id, md_serial_number;

    public FavDelete(String member_id, String md_serial_number) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/anFavDelete";
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Log.d("favDelete", "onPostExecute: 찜취소 성공");
    }
