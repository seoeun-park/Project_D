...
public class KakaoLogin extends AsyncTask<Void, Void, Void> {
    String member_id, member_loginType;

    public KakaoLogin(String member_id, String member_loginType) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            Log.d("main:kakao login", e.getMessage());
            e.printStackTrace();
        }finally {
            if(httpEntity != null){
                httpEntity = null;
    ...
    public MemberDto readMessage(InputStream inputStream) throws IOException {
        ...
        return new MemberDto(member_id, member_nickname, member_tel, member_addr, member_latitude, member_longitude,
                             member_grade, member_name, member_profile, member_loginType, member_token);
