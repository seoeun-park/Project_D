...
public class FavUpdate extends AsyncTask<Void, Void, MdDTO> {
    String md_serial_number;

    public FavUpdate(String md_serial_number) {
    ...
    protected MdDTO doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/anFavUpdate";
            ...
            Log.d("main:favUpdate", e.getMessage());
            e.printStackTrace();
        } finally {
            if(httpEntity != null){
                httpEntity = null;
