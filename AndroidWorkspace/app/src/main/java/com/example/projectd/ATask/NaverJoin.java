...
public class NaverJoin extends AsyncTask<Void, Void, String> {
    String member_id, member_nickname, member_name, member_loginType, member_token;

    public NaverJoin(String member_id, String member_nickname, String member_name,
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/anNaverJoin";
