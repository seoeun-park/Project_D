...
public class ProfilIensert extends AsyncTask<Void, Void, Void> {
    ...
    public ProfilIensert(String id, String imageDbPathA, String imageRealPathA){
        this.id = id;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/app/anProfileInsertMulti";
            // 전송
